...
-- Model name has a maximum of 11 characters (GTA Limitation). For example, a car I have in game is lib116explorer, but GTA will only read the first 11 characters, or lib116explo
Config.allowedExtras = { 
    ['leg16fpiu'] = { 2 },
    ['lib116explo'] = { 8, 12 },
}